...
class TestReasoningGymNQueens(unittest.TestCase):
    def test_n_queens_single_turn_env(self):
        # Save reset image for quick manual inspection/debugging.
        output_dir = (
            Path(__file__).resolve().parent / "test_output_reasoning_gym_n_queens"
        )
        ...
        env_id = "ReasoningGym/NQueens-v0"
        ...
        print("\n" + "=" * 80)
        print("[ReasoningGym/NQueens-v0] QUESTION:\n")
        print(obs.text[:500] if obs.text else "No text")
        print("\n[ReasoningGym/NQueens-v0] ORACLE ANSWER:\n")
        print(oracle)
        print("=" * 80 + "\n")
