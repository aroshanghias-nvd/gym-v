...
class TestReasoningGymMaze(unittest.TestCase):
    def test_maze_single_turn_env(self):
        # Save reset image for quick manual inspection/debugging.
        output_dir = Path(__file__).resolve().parent / "test_output_reasoning_gym_maze"
        ...
        print("\n" + "=" * 80)
        print("[ReasoningGym/Maze-v0] QUESTION:\n")
        print(obs.text[:500] if obs.text else "No text")
        print("\n[ReasoningGym/Maze-v0] ORACLE ANSWER:\n")
        print(oracle)
        print("=" * 80 + "\n")
