...
class MiniWorldMazeEnv(MiniWorldBaseEnv):
...
class MiniWorldMazeS2Env(MiniWorldBaseEnv):
...
class MiniWorldMazeS3Env(MiniWorldBaseEnv):
...
class MiniWorldMazeS3FastEnv(MiniWorldBaseEnv):
