...
"""
    ...
    def description(self) -> str:
        return dedent(f"""
            ...
            2. Each row and column must contain each number exactly once (Latin Square).
            3. A dot (●) between two adjacent cells means their numbers are consecutive (differ by exactly 1).
            4. If there is NO dot between two adjacent cells, their numbers must NOT be consecutive.

            Output format: {self._size} lines, each containing {self._size} numbers separated by spaces.
