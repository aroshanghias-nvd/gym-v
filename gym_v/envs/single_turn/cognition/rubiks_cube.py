...
class RubiksCubeQAEnv(Env):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._num_moves_param = num_moves
        self._num_moves = num_moves if num_moves is not None else 1
    ...
    def reset(
        ...
        self._num_moves = (
            self._num_moves_param
            if self._num_moves_param is not None
